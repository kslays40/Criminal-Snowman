...
class _JudgePageState extends State<JudgePage> {
  ...
  void _showAddCaseDialog(BuildContext context) {
    _showCaseDialog(context, 'Add Case',
        (String name, String judgeName, String status, String nextDate) {
      final newCase = Case(
          id: '',
          name: name,
          judgeName: judgeName,
  ...
  void _showEditCaseDialog(BuildContext context, Case caseItem) {
    _showCaseDialog(context, 'Edit Case',
        (String name, String judgeName, String status, String nextDate) {
            ...
            TextButton(
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  onSave(_caseName, _judgeName, _status, _nextDate);
